...
public final class Damiera {
    ...
    /**
     * Rende Damiera una classe singleton.
     */
    ...
    public static final class Posizione {
         ...
         * 
         * @param rigaIn e' l'intero che verra assegnato alla riga
         * @param colonnaIn e' l'intero che verra assegnato alla colonna
         */
         ...
         * Restituisce la riga.
         * 
         * @return e' la riga dell'oggetto posizione
         */
        public int getRiga() {
            return riga;
        }
         ...
         * 
         * @return e' la colonna dell'oggeto posizione
         */
         ...
         * 
         * @param rigaIn e' l'intero che verr� assegnato a riga 
         */
         ...
         * 
         * @param colonnaIn e' l'intero che verr� assegnato a colonna
         */
     ...
     * 
     * @return � la damiera che restituisce il metodo
     */
     ...
     * 
     * @return � la lista che restituisce il metodo
     */
     ...
     * 
     * @param listaMosseIn � la lista che verra assegnata a listaMosse
     */
     ...
     * 
     * @return � l'intero che indica il numero massimo di posizioni
     */
     ...
     * 
     * @return � l'intero che indica la grandezza della matrice damiera
     */
     ...
     * avversaria e la pedina spostata � una pedina semplice, viene effettuato lo spostamento e la pedina viene promossa a dama. 
     ...
     * @return il valore booleano indica la corretta esecuzione dello spostamento, restituisce true se lo spostamento � andato a buon fine, 
     * false altrimenti
     ...
     * di arrivo � vuota e se la pedina che l'utente vuole mangiare e' una pedina avversaria. Nel caso in cui una di queste condizioni e' falsa 
     ...
     * @param mossa e' la stringa del comando inserito dall'utente da esaminare e da eseguire nel caso sia corretta
     * @param coloreGiocatore  e' il colore del giocatore che ha inserito il comando
     * @return il valore booleano indica la corretta esecuzione della presa, restituisce true se la presa � andata a buon fine, 
     * false altrimenti
     ...
     * @param mossa e' la stringa del comando inserito dall'utente da esaminare e da eseguire nel caso sia corretta
     * @param coloreGiocatore e' il colore del giocatore che ha inserito il comando
     * @return il valore booleano indica la corretta esecuzione della presa multipla, restituisce true se la presa multipla � andata a buon fine, 
     * false altrimenti
     * @throws EccezionePresa e' l'eccezione che viene lanciata quando metodo riceve in input una mossa non corretta
     */
     ...
     * 
     * @param mossa e' la stringa che bisogna inserire all'interno della lista listaMosse
     * @param coloreGiocatore e' il colore del giocatore che ha inserito il comando
     */
